...
import (
	...
	"context"
	"fmt"
	"github.com/epilot-dev/terraform-provider-epilot-environment/internal/sdk/internal/config"
	"github.com/epilot-dev/terraform-provider-epilot-environment/internal/sdk/internal/hooks"
	"github.com/epilot-dev/terraform-provider-epilot-environment/internal/sdk/internal/utils"
	"github.com/epilot-dev/terraform-provider-epilot-environment/internal/sdk/models/errors"
	...
	"github.com/epilot-dev/terraform-provider-epilot-environment/internal/sdk/retry"
	"net/http"
	"net/url"
)

// Environments - Environment variables and secrets management
...
func (s *Environments) ListEnvironmentVariables(ctx context.Context, opts ...operations.Option) (*operations.ListEnvironmentVariablesResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.EnvironmentVariableList
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.EnvironmentVariableList = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *Environments) CreateEnvironmentVariable(ctx context.Context, request shared.EnvironmentVariableCreateRequest, opts ...operations.Option) (*operations.CreateEnvironmentVariableResponse, error) {
	...
	case httpRes.StatusCode == 201:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.EnvironmentVariable
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.EnvironmentVariable = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *Environments) ListEnvironmentGroups(ctx context.Context, opts ...operations.Option) (*operations.ListEnvironmentGroupsResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/v1/environments/groups")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.ListEnvironmentGroupsResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.EnvironmentGroupList
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.EnvironmentGroupList = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *Environments) PutEnvironmentGroup(ctx context.Context, request operations.PutEnvironmentGroupRequest, opts ...operations.Option) (*operations.PutEnvironmentGroupResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v1/environments/groups/{name}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, false, "EnvironmentGroupUpsertRequest", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}
	...
	res := &operations.PutEnvironmentGroupResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 201:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.EnvironmentGroup
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.EnvironmentGroup = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *Environments) DeleteEnvironmentGroup(ctx context.Context, request operations.DeleteEnvironmentGroupRequest, opts ...operations.Option) (*operations.DeleteEnvironmentGroupResponse, error) {
	...
	res := &operations.DeleteEnvironmentGroupResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
...
func (s *Environments) GetEnvironmentVariable(ctx context.Context, request operations.GetEnvironmentVariableRequest, opts ...operations.Option) (*operations.GetEnvironmentVariableResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v1/environments/{key}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
...
func (s *Environments) UpdateEnvironmentVariable(ctx context.Context, request operations.UpdateEnvironmentVariableRequest, opts ...operations.Option) (*operations.UpdateEnvironmentVariableResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, false, "EnvironmentVariableUpdateRequest", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}
...
func (s *Environments) DeleteEnvironmentVariable(ctx context.Context, request operations.DeleteEnvironmentVariableRequest, opts ...operations.Option) (*operations.DeleteEnvironmentVariableResponse, error) {
	...
	res := &operations.DeleteEnvironmentVariableResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
